...
- Sysmon EventCode 1 captured the PowerShell process creation with network connection.
- Key Evidence:
...
**Splunk Visibility**  <br>
- Sysmon EventCode 1 captured the PowerShell process creation with network connection and unauthorized attempt to disable windows. <br>
- Key Evidence:
  - TaskCategory = Network Connection Detected (Rule: NetworkConnect)
